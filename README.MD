...
typedef struct {
    ...
    // For percents%, the calculation is (float) dim / 100 * layout.area.dim
    // Example: if w is 9915 then real width is (float) w / 100 * layout.area.w
    // So the result is 99.15 * layout.area.w
    unsigned x_pc: 1;
    unsigned y_pc: 1;
    unsigned w_pc: 1;
    unsigned h_pc: 1;
